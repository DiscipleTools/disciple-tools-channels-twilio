...
class Disciple_Tools_Channels_Twilio_Site_Links {
    public $type = 'disciple_tools_channels_twilio';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Channels - Twilio' );
        return $type;
    }
}
Disciple_Tools_Channels_Twilio_Site_Links::instance();

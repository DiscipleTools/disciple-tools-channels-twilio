...
/**
 * Class Disciple_Tools_Channels_Twilio_Base
 * Load the core post type hooks into the Disciple Tools system
 */
class Disciple_Tools_Channels_Twilio_Base extends DT_Module_Base {
     ...
     * @var string
     */
    public $post_type = "channels_twilio";
    public $module = "channels_twilio_base";
    public $single_name = 'Channels Twilio';
    public $plural_name = 'Channels Twilio';
    public static function post_type(){
        return 'channels_twilio';
    }
    ...
    public function dt_set_roles_and_permissions( $expected_roles ){
        ...
        if ( !isset( $expected_roles["multiplier"] ) ){
            $expected_roles["multiplier"] = [
                ...
                "label" => __( 'Multiplier', 'disciple-tools-channels-twilio' ),
    ...
    public function dt_custom_fields_settings( $fields, $post_type ){
        if ( $post_type === $this->post_type ){
             ...
             */
            $fields['status'] = [
                'name'        => __( 'Status', 'disciple-tools-channels-twilio' ),
                'description' => _x( 'Set the current status.', 'field description', 'disciple-tools-channels-twilio' ),
                'type'        => 'key_select',
                'default'     => [
                    'inactive' => [
                        'label' => __( 'Inactive', 'disciple-tools-channels-twilio' ),
                        'description' => _x( 'No longer active.', 'field description', 'disciple-tools-channels-twilio' ),
                        'color' => "#F43636"
                    ],
                    'active'   => [
                        'label' => __( 'Active', 'disciple-tools-channels-twilio' ),
                        'description' => _x( 'Is active.', 'field description', 'disciple-tools-channels-twilio' ),
                        'color' => "#4CAF50"
                    ],
                ],
                'tile'     => 'status',
            ...
            $fields['assigned_to'] = [
                'name'        => __( 'Assigned To', 'disciple-tools-channels-twilio' ),
                'description' => __( "Select the main person who is responsible for reporting on this record.", 'disciple-tools-channels-twilio' ),
                'type'        => 'user_select',
                'default'     => '',
                'tile' => 'status',
             ...
             */
            $fields['start_date'] = [
                'name'        => __( 'Start Date', 'disciple-tools-channels-twilio' ),
                'description' => '',
                'type'        => 'date',
                'default'     => time(),
                'tile' => 'details',
            ...
            $fields['end_date'] = [
                'name'        => __( 'End Date', 'disciple-tools-channels-twilio' ),
                'description' => '',
                'type'        => 'date',
                'default'     => '',
                'tile' => 'details',
            ...
            $fields['location_grid'] = [
                'name'        => __( 'Locations', 'disciple-tools-channels-twilio' ),
                'description' => _x( 'The general location where this contact is located.', 'Optional Documentation', 'disciple-tools-channels-twilio' ),
                'type'        => 'location',
                'mapbox'    => false,
                "in_create_form" => true,
                "tile" => "details",
            ...
            $fields['location_grid_meta'] = [
                'name'        => __( 'Locations', 'disciple-tools-channels-twilio' ), //system string does not need translation
                'description' => _x( 'The general location where this record is located.', 'Optional Documentation', 'disciple-tools-channels-twilio' ),
                'type'        => 'location_meta',
                "tile"      => "details",
                'mapbox'    => false,
                'hidden' => true
            ...
            $fields["contact_address"] = [
                "name" => __( 'Address', 'disciple-tools-channels-twilio' ),
             ...
             */
            $fields["parents"] = [
                "name" => __( 'Parents', 'disciple-tools-channels-twilio' ),
                'description' => '',
                "type" => "connection",
            ...
            $fields["peers"] = [
                "name" => __( 'Peers', 'disciple-tools-channels-twilio' ),
                'description' => '',
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "any",
            ...
            $fields["children"] = [
                "name" => __( 'Children', 'disciple-tools-channels-twilio' ),
                'description' => '',
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "to",
             ...
             */
            $fields["peoplegroups"] = [
                "name" => __( 'People Groups', 'disciple-tools-channels-twilio' ),
                'description' => _x( 'The people groups connected to this record.', 'Optional Documentation', 'disciple-tools-channels-twilio' ),
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "to",
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ){
        if ( $post_type === $this->post_type ){
            $tiles["connections"] = [ "label" => __( "Connections", 'disciple-tools-channels-twilio' ) ];
            $tiles["other"] = [ "label" => __( "Other", 'disciple-tools-channels-twilio' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_details_additional_section( $section, $post_type ){
        ...
        if ( $post_type === $this->post_type && $section === "other" ) {
            ...
            <div class="section-subheader">
                <?php esc_html_e( "Custom Section Contact", 'disciple-tools-channels-twilio' ) ?>
            </div>
            <div>
    ...
    public static function dt_user_list_filters( $filters, $post_type ){
        ...
        if ( $post_type === self::post_type() ){
            ...
            $filters["tabs"][] = [
                "key" => "assigned_to_me",
                "label" => _x( "Assigned to me", 'List Filters', 'disciple-tools-channels-twilio' ),
                "count" => $total_my,
                "order" => 20
            ];
            ...
            $filters["filters"][] = [
                'ID' => 'my_all',
                'tab' => 'assigned_to_me',
                'name' => _x( "All", 'List Filters', 'disciple-tools-channels-twilio' ),
                'query' => [
                    'assigned_to' => [ 'me' ],
                    'sort' => 'status'
                ],
            ...
            if ( current_user_can( 'view_any_' . self::post_type() ) ){
                ...
                $filters["tabs"][] = [
                    "key" => "all",
                    "label" => _x( "All", 'List Filters', 'disciple-tools-channels-twilio' ),
                    "count" => $total_all,
                    "order" => 10
                ];
                // add assigned to me filters

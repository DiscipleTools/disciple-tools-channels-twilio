...
/**
 * Class Disciple_Tools_Channels_Twilio_Magic_Link
 */
class Disciple_Tools_Channels_Twilio_Magic_Link extends DT_Magic_Url_Base {
    ...
    public $post_type = 'channels_twilio'; // @todo set the post type this magic link connects with.
    private $meta_key = '';
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === $this->post_type ){
            $tiles["dt_starters_magic_url"] = [
                "label" => __( "Magic Url", 'disciple-tools-channels-twilio' ),
...
Disciple_Tools_Channels_Twilio_Magic_Link::instance();
